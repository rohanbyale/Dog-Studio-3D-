...
const Dog = () => {
  ...
  const [
    ...
    branchMap,
    branchNoramlMap
  ] = (useTexture(["dog_normals.jpg", "/branches_diffuse.jpg", "/branches_normals.jpg"])).map(textures => {
  ...
  return (
    ...
    <>
      ...
      <directionalLight position={[0, 15, 5,]} color={0xFFFFFF} intensity={10} />
